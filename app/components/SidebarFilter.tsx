...
export default function SidebarFilter({
    ...
    return (
        <aside className="w-[300px] flex-shrink-0 bg-white border-r border-gray-200 h-[calc(100vh-64px)] overflow-hidden flex flex-col sticky top-16 z-20">
        ...
        <div className="border-b border-gray-100 last:border-b-0">
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    {selectedInGroup > 0 && (
                        <span className="w-5 h-5 flex items-center justify-center rounded-full bg-yellow-400 text-[10px] font-bold text-black border border-yellow-500 shadow-sm animate-in zoom-in duration-300">
                            {selectedInGroup}
                        </span>
                    )}
                </div>
