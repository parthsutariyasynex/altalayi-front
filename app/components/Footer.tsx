            ...
            <div className="max-w-[1440px] mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 text-center pb-12 border-b border-gray-800/50">
                    ...
                    <div className="flex flex-col items-center group">
                        ...
                        <h3 className="text-[22px] font-bold mb-4 tracking-tight">Send us an email</h3>
                        <a
                    ...
                    <div className="flex flex-col items-center group">
                        ...
                        <h3 className="text-[22px] font-bold mb-6 tracking-tight">Connect with Us</h3>
                ...
                <div className="mt-12 flex flex-col items-center">
                    <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-[13px] font-medium text-center">
                        <p className="text-gray-500">Copyright @ 2025 Altalayi.com. All rights reserved.</p>
                        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-2">
                            <Link href="#" className="text-white hover:text-[#f5a623] transition-colors">Privacy Policy</Link>
                            <Link href="#" className="text-white hover:text-[#f5a623] transition-colors">Return Exchange Policy</Link>
                            <Link href="#" className="text-white hover:text-[#f5a623] transition-colors">Terms & Conditions</Link>
                        </div>
                    </div>
                </div>
            </div>
